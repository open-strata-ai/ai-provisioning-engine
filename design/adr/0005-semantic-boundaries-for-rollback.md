# ADR-0005: Semantic boundaries for rollback
...
Does the rollback component cascade rollback of its dependencies? A minimum rollback set needs to be defined. ---
...
This ADR solidifies the "semantic boundaries of rollback" into architectural decision records and incorporates them into `design/adr/` for continuous tracking. This issue stems from the `design/DESIGN.md` §14 open issue and is still open.
